...
var staticUrl = "http://img2.hanjiangsanguo.com/h5cdn/20151225208/static/";
var UCAPI = "http://uc.game.hanjiangsanguo.com/index.php?";
var client_version = 20151225208;
var local_version = 0;
var server_version = 0;
var appLanguage = "zh-cn";
var channelID = 150;
var jBreaking = false;
var Platform = {id: "pc", userinfo: null};
...
var ScriptQueue = {
    Loading: false, TaskQueue: [], CallBack: function (B) {
        B && B();
        this.Loading = false;
        this.Load()
    }, Load: function () {
        if (!this.Loading && this.TaskQueue.length) {
            ...
            var H = this, G = this.TaskQueue.shift(), E = document.createElement("script");
            this.Loading = true;
        ...
        this.TaskQueue.push({"src": E + D, "CallBackMethod": F});
        this.Load()
    }
};
...
var init = function () {
    ...
    function a() {
        ...
        for (var A in basejs_list) {
            var B = xjs(staticUrl + basejs_list[A]);
    ...
    function V() {
        ...
        e.css("width", "10px").animate({"width": "464px",}, A(100, 1000), "ease", V);
    ...
    function R(B, A) {
        var C = {
            "type": "get", "dataType": "text", "url": B, "complete": function (D, E) {
                D = null
            }, "success": A,
        };
        $.ajax(C)
    ...
    function d(F, A, H) {
        ...
        appFileSystem.root.getFile(E, null, function (I) {
            I.remove(function () {
                appFileSystem.root.getDirectory("sg_cache", {create: true}, G, D)
            })
        }, function () {
            appFileSystem.root.getDirectory("sg_cache", {create: true}, G, D)
        });
        ...
        function C() {
            appFileSystem.root.getFile(E, {create: true}, function (J) {
...
function orientationchangeNotice() {
    if (typeof cordova == "undefined" && window.navigator.standalone != undefined) {
        if (window.orientation == 0 || window.orientation == 180) {
            $("#orientationchange").css({"display": "block", "height": window.innerHeight});
...
function cleanGameCache() {
    ...
    if (typeof cordova == "undefined") {
        ...
        window.requestFileSystem(LocalFileSystem.PERSISTENT, 0, function (B) {
            appFileSystem = B;
            appFileSystem.root.getDirectory("sg_cache", {create: false}, function (A) {
